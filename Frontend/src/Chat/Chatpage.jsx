...
const ChatPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 px-4">
      ...
      <div className="w-full max-w-md h-[70vh] bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden">

     
        <div className="px-6 py-4 border-b border-purple-500 bg-purple-400 flex items-center gap-3 ">
        
          <img src={Ira} alt="Bot" className="w-8 h-8 rounded-full shadow-2xl  shadow-emerald-950" />
          
          <h2 className="text-lg font-semibold text-purple-800">Ira’s Little Cloud 🕊️</h2>
        </div>
